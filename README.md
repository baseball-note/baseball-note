...
- **경기** — 어제 경기 결과(점수·승/패/세이브 투수)와 오늘 경기(선발 투수, 진행 중이면 현재 점수·이닝). 오늘/어제 탭으로 넘겨 봐요.
- **우리 팀 전광판** — KIA·키움의 순위, 승패, 게임차, 연승·연패, 남은 경기
- **내 선수 카드** — 김도영·박재현·서건창의 올 시즌 기록과 리그 순위 배지(예: 홈런 1위)
- **KBO 순위표**와 **부문별 순위 TOP 20**(타자 9부문·투수 6부문)
- **선수 상세** — 카드·순위·메이저리거 어디서든 선수를 누르면 프로필(등번호·생일·키·몸무게·투타·경력)과 올 시즌 전체 기록, 리그 순위가 떠요. 기록 이름 옆의 **?**를 누르면 그 기록이 무슨 뜻인지 바로 알려줘요.
